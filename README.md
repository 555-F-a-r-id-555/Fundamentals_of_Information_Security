...
#### Семинар 1.Категорирование обрабатываемой информации

#### Семинар 1: Введение в информационную безопасность
##### Задание:
```txt
Выберите любую хорошо знакомую вам информационную систему, например: 
система контроля и управления доступом в бизнес-центр, система электронного документооборота 
в компании-работодателе, система учета заказов в пиццерии и т.д.    
1. (запишите ее название и назначение в контексте применения), 
2. укажите какие категории информации в ней обрабатываются и 
3. определите к какому классу (виду) система относится?

Доп. задание: предложите условия функционирования и/или измените состав обрабатываемой информации 
для данной информационной системы, которые приведут к новому классу (виду) системы?

Направьте ответ в текстовом формате с использованием Google Docs.
```

#### Семинар 2. Семинар: Моделирование угроз и выбор мер защиты
###### Задание:
```txt
1. Используя полученный в ходе выполнения файл XLSX/CSV-файла «Перечень сформированных угроз», 
2. сформируйте перечень уникальных мер защиты, подсчитав вклад каждой меры в нейтрализацию соответствующего способа реализации угрозы (+1 балл). 
3. Отсортируйте полученный перечень по убыванию в части полученных баллов.
...
4. Доп. задание: сделайте маппинг полученных мер с мерами из CIS Controls и/или NIST Cybersecurity Framework (CSF) там, где это возможно.
...
```
* Ответ:
<details> <summary>Показать Python скрипт с mappings(Нажми, чтобы раскрыть)</summary>
...
1. Задание №2 “Дискреционное управление доступом”
...
2.1. Задание №3 “Просмотр событий” (вопрос для Windows)
Семинар 3. Основные технологии и инструменты обеспечения ИБ (некриптографические)
...
2.2. Задание №3 “Просмотр событий” (вопрос для Linux)
Семинар 3. Основные технологии и инструменты обеспечения ИБ (некриптографические)
...
📌 Выйти из операционной системы, повторно войти, сначала введя 
неверный пароль, найти событие неуспешного входа.
📌 Ознакомиться с другими событиями.


3. Доп. задание: напишите программу на Python, которая будет взаимодействовать с API VirusTotal.
...
* Ответ, задание 2 для kali:

<details> <summary>Показать команды Linux(Нажми, чтобы раскрыть)</summary>
...
┌──(kali㉿kali)-[/var]
└─$ mkdir recovery
mkdir: cannot create directory ‘recovery’: Permission denied
...
┌──(kali㉿kali)-[/var]
└─$ echo "Это текст в файле" > recovery/file.txt
zsh: permission denied: recovery/file.txt
                                                                                                                    
┌──(kali㉿kali)-[/var]
└─$ ls   
backups  cache  lib  local  lock  log  mail  opt  recovery  run  spool  tmp  www
                                                                                                                     
┌──(kali㉿kali)-[/var]
└─$ sudo su                                          
┌──(root㉿kali)-[/var]
└─# echo "Something Interesting text" > recovery/test.txt
                                                                                                                     
┌──(root㉿kali)-[/var]
└─# chgrp testteam ./recovery                            
                                                                                                                     
┌──(root㉿kali)-[/var]
└─# ls -l
total 44
drwxr-xr-x  2 root root     4096 Jun  4 02:48 backups
drwxr-xr-x 20 root root     4096 Jun  4 02:06 cache
drwxr-xr-x 75 root root     4096 Jun  2 07:23 lib
drwxrwsr-x  2 root staff    4096 Feb 16 23:10 local
lrwxrwxrwx  1 root root        9 Apr 23 03:59 lock -> /run/lock
drwxr-xr-x 20 root root     4096 Jun  4 05:53 log
drwxrwsr-x  2 root mail     4096 Apr 23 03:59 mail
drwxr-xr-x  2 root root     4096 Apr 23 03:59 opt
drwxr-xr-x  2 root testteam 4096 Jun  4 06:02 recovery
lrwxrwxrwx  1 root root        4 Apr 23 03:59 run -> /run
drwxr-xr-x  3 root root     4096 Apr 23 03:59 spool
drwxrwxrwt  8 root root     4096 Jun  4 06:09 tmp
drwxr-xr-x  3 root root     4096 Apr 23 04:07 www
...
drwxrwsr-x  2 root mail     4096 Apr 23 03:59 mail
drwxr-xr-x  2 root root     4096 Apr 23 03:59 opt
drwxr-----  2 root testteam 4096 Jun  4 06:02 recovery
lrwxrwxrwx  1 root root        4 Apr 23 03:59 run -> /run
drwxr-xr-x  3 root root     4096 Apr 23 03:59 spool
drwxrwxrwt  8 root root     4096 Jun  4 06:09 tmp
drwxr-xr-x  3 root root     4096 Apr 23 04:07 www
...
┌──(root㉿kali)-[/var]
└─# getent group testteam
testteam:x:1003:kali,test_user2
                                                                                                                     
┌──(root㉿kali)-[/var]
└─# newgrp testteam
┌──(root㉿kali)-[/var]
└─# sudo chown kali:testteam /var/recovery
...
drwxrwsr-x  2 root mail     4096 Apr 23 03:59 mail
drwxr-xr-x  2 root root     4096 Apr 23 03:59 opt
drwxr-----  2 kali testteam 4096 Jun  4 06:02 recovery
lrwxrwxrwx  1 root root        4 Apr 23 03:59 run -> /run
drwxr-xr-x  3 root root     4096 Apr 23 03:59 spool
drwxrwxrwt  8 root root     4096 Jun  4 06:09 tmp
drwxr-xr-x  3 root root     4096 Apr 23 04:07 www
...
┌──(kali㉿kali)-[~/Documents]
└─$ sudo chgrp testteam ./recovery   
                                                                    
┌──(kali㉿kali)-[~/Documents]
└─$ ls -l 
total 4
drwxrwxr-x 2 kali testteam 4096 Jun  4 02:38 recovery
...
└─$ ls -l               
total 4
drwxr----- 2 kali testteam 4096 Jun  4 02:38 recovery
                                                                    
┌──(kali㉿kali)-[~/Documents]
└─$ sudo -u test_user ls ./recovery 
ls: cannot open directory './recovery': Permission denied
                                                                    
┌──(kali㉿kali)-[~/Documents]
└─$ sudo -u kali ls ./recovery
test.txt
                                                                    
┌──(kali㉿kali)-[~/Documents]
└─$ getent group testteam 

testteam:x:1003:kali

┌──(kali㉿kali)-[~/Documents]
└─$ sudo usermod -aG testteam test_user2
...
──(kali㉿kali)-[~]
└─$ sudo journalctl -u lightdm | grep "authentication failure"

[sudo] password for kali: 
Jun 04 05:41:31 kali lightdm[108575]: pam_unix(lightdm:auth): authentication failure; logname= uid=0 euid=0 tty=:1 ruser= rhost=  user=test_user
Jun 04 05:41:39 kali lightdm[108642]: pam_unix(lightdm:auth): authentication failure; logname= uid=0 euid=0 tty=:1 ruser= rhost=  user=test_user
                                                                                                             
┌──(kali㉿kali)-[~]
└─$ sudo journalctl | grep "authentication failure"           
Jun 04 02:24:57 kali sudo[15233]: pam_unix(sudo:auth): authentication failure; logname=kali uid=1000 euid=0 tty=/dev/pts/1 ruser=kali rhost=  user=kali
Jun 04 05:41:31 kali lightdm[108575]: pam_unix(lightdm:auth): authentication failure; logname= uid=0 euid=0 tty=:1 ruser= rhost=  user=test_user
Jun 04 05:41:39 kali lightdm[108642]: pam_unix(lightdm:auth): authentication failure; logname= uid=0 euid=0 tty=:1 ruser= rhost=  user=test_user
                                                                                                             
┌──(kali㉿kali)-[~]
└─$ sudo journalctl | grep "session opened"
Jun 02 07:23:04 kali lightdm[875]: pam_unix(lightdm-greeter:session): session opened for user lightdm(uid=112) by (uid=0)
Jun 02 07:23:04 kali (systemd)[881]: pam_unix(systemd-user:session): session opened for user lightdm(uid=112) by lightdm(uid=0)
Jun 02 07:23:05 kali lightdm[875]: pam_unix(lightdm-greeter:session): session opened for user lightdm(uid=112) by (uid=0)
Jun 02 07:23:14 kali lightdm[980]: pam_unix(lightdm:session): session opened for user kali(uid=1000) by kali(uid=0)
Jun 02 07:23:15 kali (systemd)[992]: pam_unix(systemd-user:session): session opened for user kali(uid=1000) by kali(uid=0)

┌──(kali㉿kali)-[~]
└─$ last 
kali     tty7         :0               Wed Jun  4 08:23 - still logged in
lightdm  tty7         :0               Wed Jun  4 08:23 - 08:23  (00:00)
kali     tty7         :0               Wed Jun  4 07:54 - 08:23  (00:28)
lightdm  tty7         :0               Wed Jun  4 07:54 - 07:54  (00:00)
lightdm  tty10        :3               Wed Jun  4 07:20 - 07:20  (00:00)
lightdm  tty10        :3               Wed Jun  4 06:50 - 06:51  (00:00)
lightdm  tty10        :3               Wed Jun  4 06:49 - 06:49  (00:00)
root     pts/1                         Wed Jun  4 06:00 - 07:20  (01:20)
kali     tty9         :2               Wed Jun  4 05:53 - 07:53  (01:59)
lightdm  tty9         :2               Wed Jun  4 05:53 - 05:53  (00:00)
test_use tty8         :1               Wed Jun  4 05:52 - 07:53  (02:00)
lightdm  tty8         :1               Wed Jun  4 05:52 - 05:52  (00:00)
test_use tty7         :0               Wed Jun  4 05:51 - 07:53  (02:02)
lightdm  tty7         :0               Wed Jun  4 05:50 - 05:51  (00:00)
lightdm  tty10        :3               Wed Jun  4 05:49 - 05:49  (00:00)
lightdm  tty10        :3               Wed Jun  4 05:46 - 05:46  (00:00)
lightdm  tty10        :3               Wed Jun  4 05:44 - 05:44  (00:00)
test_use tty9         :2               Wed Jun  4 05:44 - 05:50  (00:06)
lightdm  tty9         :2               Wed Jun  4 05:43 - 05:44  (00:00)
test_use tty8         :1               Wed Jun  4 05:41 - 05:50  (00:08)
lightdm  tty8         :1               Wed Jun  4 05:41 - 05:41  (00:00)
lightdm  tty8         :1               Wed Jun  4 02:00 - 02:00  (00:00)
lightdm  tty8         :1               Wed Jun  4 01:59 - 01:59  (00:00)
kali     tty7         :0               Wed Jun  4 01:57 - 05:50  (03:52)
lightdm  tty7         :0               Wed Jun  4 01:57 - 01:57  (00:00)
kali     tty7         :0               Mon Jun  2 07:26 - 07:45  (00:19)
lightdm  tty7         :0               Mon Jun  2 07:25 - 07:26  (00:00)
kali     tty7         :0               Mon Jun  2 07:23 - 07:24  (00:01)
lightdm  tty7         :0               Mon Jun  2 07:23 - 07:23  (00:00)
postgres                               Wed Apr 23 04:17 - 04:17  (00:00)

/var/lib/wtmpdb/wtmp.db begins Wed Apr 23 04:17:05 2025

┌──(kali㉿kali)-[~]
└─$ sudo journalctl -u lightdm   
Jun 04 05:41:31 kali lightdm[108575]: pam_unix(lightdm:auth): authentication failure; logname= uid=0 euid=0 >
Jun 04 05:41:31 kali lightdm[108575]: pam_winbind(lightdm:auth): getting password (0x00000388)
Jun 04 05:41:31 kali lightdm[108575]: pam_winbind(lightdm:auth): pam_get_item returned a password
Jun 04 05:41:31 kali lightdm[108575]: pam_winbind(lightdm:auth): request wbcLogonUser failed: WBC_ERR_WINBIN>
Jun 04 05:41:31 kali lightdm[108575]: pam_winbind(lightdm:auth): internal module error (retval = PAM_AUTHINF>
Jun 04 05:41:39 kali lightdm[108642]: pam_unix(lightdm:auth): authentication failure; logname= uid=0 euid=0 >
Jun 04 05:41:39 kali lightdm[108642]: pam_winbind(lightdm:auth): getting password (0x00000388)
Jun 04 05:41:39 kali lightdm[108642]: pam_winbind(lightdm:auth): pam_get_item returned a password
...
#### Семинар 4: Основы криптографической защиты информации
##### Задание:
```txt
1. Самостоятельно выполнить задание 3 сегодняшнего семинара с операционными системами, которые не были доступны студенту во время занятия.
...
Windows:
- в командной строке: certutil -hashﬁle "путь к файлу" SHA256
- в PowerShell-оболочке: get-ﬁlehash -Algorithm SHA256 "путь к файлу"
📌 Рассчитать хэш SHA-2 (длина хэша 256) для файла с использованием встроенных средств 
Linux: 
- sha256sum "путь к файлу".
📌 Проверить полученные значения хэшей на веб-ресурсах: https://hash-ﬁle.online/ и/или 
https://www.strerr.com/ru/sha256_ﬁle.html
📌 Сделать скриншоты (Google Docs).

Задание  №3. Расчет и проверка хэшей. Строка
📌 Рассчитать хэш SHA-2 (длина хэша 256) для текста («test»):
- в командной строке: echo|set /p="test" > %TMP%/hash.txt |certutil -hashﬁle 
%TMP%/hash.txt SHA256 | ﬁndstr /v "hash"
📌 Рассчитать хэш SHA-2 (длина хэша 256) для файла с использованием встроенных средств 
Linux: 
...
1. 
```sh
PS D:\Fundamentals_of_Information_Security\Fundamentals_of_Information_Security\homework_4> get-filehash -Algorithm SHA256 "D:\\Fundamentals_of_Information_Security\\Fundamentals_of_Information_Security\\homework_4\\hash.txt"

Algorithm       Hash                                                                   Path
---------       ----                                                                   ----
SHA256          B0837559F9C780DA799214524DC2DDE7228C29C89E61F33E37AA1E8D14A82819       D:\Fundamentals_of_Information_Security\Fundamentals_of_Information_Security\homework_4\hash.txt


PS D:\Fundamentals_of_Information_Security\Fundamentals_of_Information_Security\homework_4>
PS D:\Fundamentals_of_Information_Security\Fundamentals_of_Information_Security\homework_4>
PS D:\Fundamentals_of_Information_Security\Fundamentals_of_Information_Security\homework_4>
PS D:\Fundamentals_of_Information_Security\Fundamentals_of_Information_Security\homework_4> node
Welcome to Node.js v20.17.0.
Type ".help" for more information.
>
>
>
> "B0837559F9C780DA799214524DC2DDE7228C29C89E61F33E37AA1E8D14A82819" == "b0837559f9c780da799214524dc2dde7228c29c89e61f33e37aa1e8d14a82819".toUpperCase();
true
> "B0837559F9C780DA799214524DC2DDE7228C29C89E61F33E37AA1E8D14A82819" === "b0837559f9c780da799214524dc2dde7228c29c89e61f33e37aa1e8d14a82819".toUpperCase();
true
```
2. 
```sh
Fred@DESKTOP-N MINGW64 /d/Fundamentals_of_Information_Security/Fundamentals_of_Information_Security/homework_4
$ echo -n test| sha256sum
...
Welcome to Node.js v20.17.0.
Type ".help" for more information.
> "9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08" === "9f86d08188
4c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08"
true
>
```

* [file_hash.py](https://github.com/555-F-a-r-id-555/Fundamentals_of_Information_Security/blob/main/homework_4/file_hash.py) 
* [string_hash.py](https://github.com/555-F-a-r-id-555/Fundamentals_of_Information_Security/blob/main/homework_4/string_hash.py) 
...
```
#### Ответ:
* v1: [check_password_complexity_v1.py](https://github.com/555-F-a-r-id-555/Fundamentals_of_Information_Security/blob/main/homework_5/check_password_complexity_v1.py)
* v2: [check_password_complexity_v2.py](https://github.com/555-F-a-r-id-555/Fundamentals_of_Information_Security/blob/main/homework_5/check_password_complexity_v2.py)
* v3: [check_password_complexity_v3.py](https://github.com/555-F-a-r-id-555/Fundamentals_of_Information_Security/blob/main/homework_5/check_password_complexity_v3.py)

#### Семинар 6: Оценка и анализ защищённости
##### Задание:
```txt
...
```
#### Ответ:
* [nmap_scanner.py](https://github.com/555-F-a-r-id-555/Fundamentals_of_Information_Security/blob/main/homework_6/nmap_scanner.py)
